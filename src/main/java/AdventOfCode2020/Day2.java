...
public class Day2 {
    public static void main(String[] args) {
        ...
        int numberOfValidPasswordsPart1 = 0, numberOfValidPasswordsPart2 = 0;
        //////////////////////
        ...
        for (String line : passwordsAndPolicies) {
            ...
            int leftNum = Integer.parseInt(segments[0]);
            int rightNum = Integer.parseInt(segments[1]);
            ...
            if ((letterCount >= leftNum) && (letterCount <= rightNum)) {
                numberOfValidPasswordsPart1++;
            }

            // Exlcusive Or (XOR) for character at left or right number location in password
            if ((password.charAt(leftNum - 1) == letter) 
                ^ (password.charAt(rightNum - 1) == letter)) {
                numberOfValidPasswordsPart2++;
            }
        }
